    ...
    <div className="bg-[#fafaf5] min-h-screen font-sans antialiased">
      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="flex flex-col items-center">
                <span className="text-4xl font-headline font-bold text-primary mb-2">100%</span>
              ...
              <div className="flex flex-col items-center border-x-0 md:border-x border-[#c0c9bb]/30">
                <span className="text-4xl font-headline font-bold text-primary mb-2">Zero</span>
                <span className="text-xs font-label uppercase tracking-widest text-[#41493e] font-semibold">Batch Rejections in 2023</span>
              </div>
              <div className="flex flex-col items-center">
                <span className="text-4xl font-headline font-bold text-primary mb-2">45+</span>
          ...
          <div className="container mx-auto px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-[#ffffff] p-8 group hover:bg-[#fafaf5] transition-all duration-300">
                ...
                <span className="text-[0.65rem] font-bold text-primary uppercase tracking-tighter">Status: Active Renewal</span>
              </div>
              ...
              <div className="bg-[#ffffff] p-8 group hover:bg-[#fafaf5] transition-all duration-300">
                ...
                <span className="text-[0.65rem] font-bold text-primary uppercase tracking-tighter">Global Gold Standard</span>
              </div>
              ...
              <div className="bg-[#ffffff] p-8 group hover:bg-[#fafaf5] transition-all duration-300">
                ...
                <span className="text-[0.65rem] font-bold text-primary uppercase tracking-tighter">Verified Farm Network</span>
              </div>
              ...
              <div className="bg-[#ffffff] p-8 group hover:bg-[#fafaf5] transition-all duration-300">
                ...
                <span className="text-[0.65rem] font-bold text-primary uppercase tracking-tighter">Supply Chain Security</span>
              </div>
              ...
              <div className="bg-[#ffffff] p-8 group hover:bg-[#fafaf5] transition-all duration-300">
                ...
                <span className="text-[0.65rem] font-bold text-primary uppercase tracking-tighter">Aquatic Excellence</span>
              </div>
              ...
              <div className="bg-[#ffffff] p-8 group hover:bg-[#fafaf5] transition-all duration-300">
                ...
                <span className="text-[0.65rem] font-bold text-primary uppercase tracking-tighter">Religious Compliance</span>
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="space-y-24">
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className="md:text-right">
                    <span className="inline-block px-3 py-1 bg-primary/10 text-primary text-[0.65rem] font-bold uppercase tracking-widest mb-4">Phase 01</span>
                  ...
                  <div className="relative">
                    <div className="absolute top-1/2 left-[-3rem] md:left-[-3.25rem] w-6 h-6 bg-primary rounded-full z-10 border-4 border-[#f4f4ef] hidden md:block"></div>
                    <img
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className="order-2 md:order-1 relative">
                    <div className="absolute top-1/2 right-[-3rem] md:right-[-3.25rem] w-6 h-6 bg-primary rounded-full z-10 border-4 border-[#f4f4ef] hidden md:block"></div>
                    <img
                      className="w-full h-64 object-cover rounded-xl shadow-lg"
                  ...
                  <div className="order-1 md:order-2">
                    <span className="inline-block px-3 py-1 bg-primary/10 text-primary text-[0.65rem] font-bold uppercase tracking-widest mb-4">Phase 02</span>
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className="md:text-right">
                    <span className="inline-block px-3 py-1 bg-primary/10 text-primary text-[0.65rem] font-bold uppercase tracking-widest mb-4">Phase 03</span>
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="order-1 md:order-2">
                    <span className="inline-block px-3 py-1 bg-primary/10 text-primary text-[0.65rem] font-bold uppercase tracking-widest mb-4">Phase 04</span>
        ...
        <section className="py-24 bg-[#fafaf5] overflow-hidden">
          <div className="container mx-auto px-8">
            <div className="bg-primary text-white p-12 md:p-20 rounded-xl relative overflow-hidden flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto bg-white border border-[#c0c9bb]/30 p-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/contact"
                  className="bg-primary text-white px-8 py-4 rounded-md font-bold text-sm tracking-wide transition-all transform hover:scale-105 active:scale-95 shadow-md flex items-center gap-2"
                >
                ...
                <Link
                  to="/contact"
                  className="bg-transparent border border-primary text-primary px-8 py-4 rounded-md font-bold text-sm tracking-wide transition-all hover:bg-primary/5"
                >
